...
from lpcvc.models import get_student_model, get_teacher_model
...
from lpcvc.optimizers import get_st_optimizer
...
def train(cfg):
    ...
    # 일단 여기서 멈춤 1트
    sg_loss, pi_loss, pa_loss = get_dist_loss_function(cfg["training"])
    if local_rank == 0:
        logger.info("Using loss {}".format(sg_loss))
    ...
    # Setup Model / 고쳐야 돼용 discriminator
